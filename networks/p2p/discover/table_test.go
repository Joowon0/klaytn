...
func testPingReplace(t *testing.T, newNodeIsResponding, lastInBucketIsResponding bool) {
	...
	pingSender := NewNode(MustHexID("a502af0f59b2aab7746995408c79e9ca312d2793cc997e44fc55eda62f0150bbb8c59a6f9269ba3a081518b62699ee807c7c19c20125ddfccca872608af9e370"),
		net.IP{}, 99, []uint16{99}, NodeTypeUnknown)
...
func TestTable_Lookup(t *testing.T) {
	...
	seed := NewNode(lookupTestnet.dists[256][0], net.IP{}, 256, []uint16{0}, NodeTypeUnknown)
...
func (tn *preminedTestnet) findnode(toid NodeID, toaddr *net.UDPAddr, target NodeID, nType NodeType, max int) ([]*Node, error) {
	...
	for i, id := range tn.dists[toaddr.Port] {
		result = append(result, NewNode(id, net.ParseIP("127.0.0.1"), next, []uint16{uint16(i)}, NodeTypeUnknown))
	}
	return result, nil
}
